...
<body>
	...
	<div id="essayWin">
			...
			<div style="margin: 10px 0">
				类型:<select class="easyui-combobox" id="type" style="width: 200px;">
					<option value="1">侦探</option>
			...
			<a href="javascript:void(0)" id="btn-add" onclick="addOrUpdateEssay(this)" class="easyui-linkbutton" iconCls="icon-save">保存</a>
</body>
</html>
